...
import HarvestMap from './pages/HarvestMapPage'
import HarvestMapPricingPage from './pages/HarvestMapPricingPage'
...
const NAV: NavItem[] = [
  ...
  { key: 'harvestmap', label: 'HarvestMap', icon: MapPin },
  { key: 'harvestmap-pricing', label: 'HarvestMap Pricing', icon: DollarSign },
  ...
  return (
    <div className="flex h-screen w-screen overflow-hidden">
      ...
      <main className="flex-1 overflow-y-auto">
        ...
        {active === 'harvestmap' && <HarvestMap />}
        {active === 'harvestmap-pricing' && <HarvestMapPricingPage />}
