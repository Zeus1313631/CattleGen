    ...
    <div className="rounded-lg border border-amber-300 bg-amber-50 p-4 flex gap-3">
      ...
      <div className="flex-1">
        ...
        <p className="mt-1 text-sm text-amber-900 leading-relaxed">
          ...
          in some cases different units. Breeding predictions across these
          systems are disabled. USMARC 2024 AB-EPD adjustments apply only to
          EPD-based breeds; WBV (AWA-AU) cannot be converted to this scale.
        </p>
        <button
        ...
        <div className="card-body space-y-4 text-sm text-ranch-800">
          ...
          <section>
            ...
            <p>
              ...
              bulls from 18 different breeds on a common Angus-base scale.
              CattleGen automatically applies these adjustments when both parents
              use EPD systems covered by the USMARC table (Angus, Red Angus,
              Hereford, Simmental, Limousin, Brahman, Beefmaster). The result is
              labelled <strong>AB-EPD Adjusted</strong> and covers seven shared
              traits: BW, WW, YW, Milk, Marb, RE, and Fat.
            </p>
            <p>
              WBV (Australian Wagyu) is not covered by the USMARC table and
              cannot be compared on this basis.
            </p>
            <p>
              Reference:{' '}
              <button
